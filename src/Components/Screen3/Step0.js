                ...
                <div className={classes.formContainer}>
                    ...
                    >
                        ...
                        <Typography variant="caption" className={classes.subText}>
                            Please note that upon turn in,the mileage on your car<br/>cannot be more than
                            250 miles over the amount entered here.
                        </Typography>
                        ...
                        <RadioGroup aria-label="keys" name="keys" value={stepFields.keys} onChange={handleStepChange} className={classes.radio}>
                            <FormControlLabel value="yes" control={<Radio />} label="Yes"  className={classes.radioChecked}/>
                            <FormControlLabel value="no" control={<Radio />} label="No" className={classes.radioChecked} />
                        </RadioGroup>
                        <Divider className={classes.divider} />
                        <Typography variant="caption" className={classes.label}>
                           Select Color
